    ...
    <div className="min-h-screen bg-surface-alt">
      ...
      <div className="mx-auto flex w-full max-w-6xl gap-6 p-4 md:p-6">
        <nav className="hidden w-48 shrink-0 flex-col gap-1 md:flex" aria-label="Navigation">
          ...
          {canReadContent ? (
            <NavLink to="/cms/careers" className={navLinkClass}>
              CMS · Fursadaha
            </NavLink>
          ) : null}
          {canReadContent ? (
            <NavLink to="/cms/testimonials" className={navLinkClass}>
              CMS · Marag-furka
            </NavLink>
          ) : null}
          {canReadContent ? (
          ...
          {canReadContent ? (
            <NavLink to="/cms/faqs" className={navLinkClass}>
              CMS · Su’aalaha
            </NavLink>
          ) : null}
          {canReadContent ? (
            <NavLink to="/cms/subscribers" className={navLinkClass}>
              CMS · Warsidaha
            </NavLink>
          ) : null}
          {canReadUsers ? (
